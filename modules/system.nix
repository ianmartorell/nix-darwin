...
###################################################################################
{
  ...
  launchd.user.agents.hidutil-apple.serviceConfig = {
    ProgramArguments = [
      "/usr/bin/hidutil"
      "property"
      "--match"
      ...
      (
        let
          ...
          escape = "0x700000029";
          nonUSBackslash = "0x700000064";
          tilde = "0x700000035";
          backslash = "0x700000031";
        in
        "{\"UserKeyMapping\":[
          {
          ...
          },
          {
            ...
            \"HIDKeyboardModifierMappingDst\":${tilde}
          },
          {
            \"HIDKeyboardModifierMappingSrc\":${tilde},
            \"HIDKeyboardModifierMappingDst\":${backslash}
          }
        ]}"
      )
    ];
  ...
  # Special hidutil configuration for Keychron K13 Pro
  launchd.user.agents.hidutil.serviceConfig = {
    ProgramArguments = [
      "/usr/bin/hidutil"
      "property"
      "--match"
      "{\"ProductID\":0x2d1,\"VendorID\":0x3434,\"Product\":\"Keychron K13 Pro\"}"
      "--set"
      (
        let
          capsLock = "0x700000039";
          escape = "0x700000029";
          keyLeftOfZ = "0x700000064"; # Key that produces ` (backtick)
          keyLeftOf1 = "0x700000035"; # Key that produces § (section sign)
          backslash = "0x700000031";
        in
        "{\"UserKeyMapping\":[
          {
          ...
          {
            \"HIDKeyboardModifierMappingSrc\":${keyLeftOf1},
            \"HIDKeyboardModifierMappingDst\":${keyLeftOfZ}
          },
          {
            \"HIDKeyboardModifierMappingSrc\":${keyLeftOfZ},
            \"HIDKeyboardModifierMappingDst\":${backslash}
          }
        ]}"
      )
